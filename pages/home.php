                        ...
                        <div class="navbar-footer">
                            <div class="mb-60">
                                ...
                                <ul class="list-group borderless font-size-17">
                                    <li class="list-group-item">Email: <a href="#">hello@themebau.com</a></li>
                                    <li class="list-group-item">Phone: <a href="#">+44 207 112 82 85</a></li>
                                </ul>
                            </div>
                            <div class="mb-60">
        ...
        <div class="content-wrap">
            <div class="pt-160 pb-130 mt-10 shape-parent">
                <div class="container text-center">
                    <div class="row justify-content-center text-center">
                        <div class="col-12 col-lg-10 col-xl-8">
                            <h1 class="mb-60 show-on-scroll" data-show-duration="500" data-show-distance="20">An award-winning digital studio ✌️</h1>
                            <a href="contact-1.html" class="btn btn-dark btn-with-ball show-on-scroll" data-show-delay="60" data-show-duration="500" data-show-distance="20">let’s work</a>
                        </div>
                    </div>
                </div>
                <div class="shape mt-n160">
                    <svg data-rellax-speed="-1" width="518" height="641" viewBox="0 0 518 641" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="197.5" cy="320.5" r="320.5" fill="#F5F5F5" />
                    </svg>
                </div>
            </div>
            <div class="container isotope">
                <ul class="nav justify-content-center isotope-options mb-60">
                    <li class="nav-item active show-on-scroll" data-show-duration="400" data-show-distance="10">
                        <a href="#" data-filter="all" class="nav-link">
                            <div class="nav-link-name">all projects</div>
                        </a>
                    </li>
                    <li class="nav-item show-on-scroll" data-show-delay="50" data-show-duration="400" data-show-distance="10">
                        <a href="#" data-filter="branding" class="nav-link">
                            <div class="nav-link-name">branding</div>
                        </a>
                    </li>
                    <li class="nav-item show-on-scroll" data-show-delay="150" data-show-duration="400" data-show-distance="10">
                        <a href="#" data-filter="design" class="nav-link">
                            <div class="nav-link-name">design</div>
                        </a>
                    </li>
                    <li class="nav-item show-on-scroll" data-show-delay="200" data-show-duration="400" data-show-distance="10">
                        <a href="#" data-filter="photography" class="nav-link">
                            <div class="nav-link-name">photography</div>
                        </a>
                    </li>
                    <li class="nav-item show-on-scroll" data-show-delay="250" data-show-duration="400" data-show-distance="10">
                        <a href="#" data-filter="marketing" class="nav-link">
                            <div class="nav-link-name">marketing</div>
                        </a>
                    </li>
                </ul>
                <div class="pt-30">
                    <div class="row align-items-end gh-1 gv-1 isotope-grid">
                        <div class="col-12 col-sm-6 col-sm-6 col-lg-4 isotope-item" data-filters="branding">
                            <a href="portfolio-single-style-1.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Watch Design" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/watch-design-740-540.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4 isotope-item" data-filters="photography">
                            <a href="portfolio-single-style-2.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Happy Moments Photoset" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/happy-moments-740-860.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-sm-6 col-lg-4 isotope-item" data-filters="design">
                            <a href="portfolio-single-style-3.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Mobile App" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/mobile-app-740-540.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4 isotope-item" data-filters="branding">
                            <a href="portfolio-single-style-4.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Bag Design" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/bag-design-740-860.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4 isotope-item" data-filters="branding">
                            <a href="portfolio-single-style-5.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Creative Branding" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/creative-branding-740-860.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-sm-6 col-lg-4 isotope-item" data-filters="design">
                            <a href="portfolio-single-style-6.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Package Design" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/package-design-740-540.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-sm-6 col-lg-4 isotope-item" data-filters="marketing">
                            <a href="portfolio-single-style-1.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Video Tutorial" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/video-tutorial-740-540.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4 isotope-item" data-filters="design">
                            <a href="portfolio-single-style-2.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Identity Design" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/identity-design-740-860.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-sm-6 col-lg-4 isotope-item" data-filters="design">
                            <a href="portfolio-single-style-3.html" class="d-block show-on-scroll" data-cursor-style="cursor-text" data-cursor-text="Breakfast" data-show-delay="50" data-show-distance="5" data-show-duration="500">
                                <img class="mw-100" src="assets/images/portfolio/breakfast-740-540.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="py-160 mt-n10 text-center">
                    <h3 class="mb-60">Do you have a project?<br>Send us a message and let's connect 👋</h3>
                    <a href="contact-1.html" class="btn btn-dark btn-with-ball mt-n10">let’s work</a>
                </div>
            </div>
        </div>
