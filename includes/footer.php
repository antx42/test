<footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60">
            ...
            <div class="container pt-4">
                <ul class="nav align-items-center flex-column text-white mb-100">
                    <li class="nav-item">
                        <a href="#" class="nav-link h2 mb-8 mb-md-30 d-none d-md-flex">hello@themebau.com</a>
                        <a href="#" class="nav-link h4 mb-8 mb-md-30 d-md-none">hello@themebau.com</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link h4 mt-8 mt-md-0">+44 207 112 82 85</a>
                    </li>
                </ul>
                ...
                <div class="footer-copyright mb-5">© 2020 - Themebau.</div>
            </div>
        </footer>
        <!-- START: Scripts -->
        <!-- Object Fit Polyfill -->
